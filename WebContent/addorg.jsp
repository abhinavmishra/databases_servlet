...
<body>
<form name="add" action="addorg" method="post" onsubmit = "return validateForm()">
<p>
Add or Remove:
<select name="option">
...
<p>
Position Count <input type="text" name="position_count" size="5" maxlength="11">
</p>
<p>
Member Count <input type="text" name="member_count" size="5" maxlength="11">
</p>
Governing Body: 
<select name ="gov_body"> 
<option value = ""></option>
 <%  while(rset.next()){ %>
